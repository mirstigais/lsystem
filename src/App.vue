<template>
  <div class="menu-wrapper">
    <el-menu :default-active="activeIndex" class="el-menu-lsystem" mode="horizontal" @select="handleSelect">
    ...
    <div class="lang-wrapper">
      ...
      <el-select v-model="lang" style="width: 100px" @change="handleLanguageChange">
